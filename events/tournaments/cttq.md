...
<div class="tournament-page-shell">
    <header class="tournament-page-header">
        <div class="tournament-page-kicker">Kết quả theo tháng</div>
        <h1>Các kỳ thủ đạt giải <a href="/events/cttq-chien-truong-thi-quan">Chiến Trường Thí Quân</a></h1>
        <p>Bảng tổng hợp điểm và thứ hạng của các kỳ thủ theo từng tháng.</p>
    </header>
    ...
    <div class="tournament-page-context">
        <div>
            ...
            <a href="/leaders#admin3">M-DinhHoangViet</a>
        </div>
        <a class="tournament-context-link" href="/events/cttq-chien-truong-thi-quan">Xem thông tin sự kiện <span aria-hidden="true">↗</span></a>
    </div>
    ...
    <section class="tournament-results-section" aria-label="Bảng tổng hợp Chiến Trường Thí Quân">
