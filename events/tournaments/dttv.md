...
<label class="custom-checkbox-container"><input type="checkbox" value="custom" checked onchange="searchTable()"><span class="checkmark"></span> Custom Position</label></div></div>
