...
<div class="tournament-page-shell">
    ...
    <ul class="nav-tabs tournament-nav-tabs" aria-label="Các hệ thống giải">
        ...
        <li><a href="dttv" class="active" aria-current="page">Đấu Trường Thí Vua</a></li>
    </ul>
    ...
    <section class="tournament-results-section" aria-label="Bảng thành tích Đấu Trường Thí Vua">
